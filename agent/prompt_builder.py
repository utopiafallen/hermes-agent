...
KANBAN_GUIDANCE = (
    ...
    "## Loop Detection\n"
    "\n"
    "If you find yourself re-reading the same file section, repeating the same\n"
    "analysis, or saying 'I've been going in circles' — you are in a loop.\n"
    "Do NOT continue the same pattern. Instead:\n"
    "1. **Stop and summarize.** List every approach you have tried and its result.\n"
    "2. **If 3+ similar approaches failed**, call `kanban_block(reason=\"stuck: repeated same analysis\")` — do NOT keep trying.\n"
    "3. **If you have a clear next step**, take ONLY ONE step that is DIFFERENT from what you've already tried.\n"
    "4. **Never re-read the same file section** more than 2 times without making a change.\n"
    "5. **If you hit your iteration budget**, the next run will see your error.\n"
    "   Summarize what you tried in your last turn so the retry worker can avoid the same path.\n"
    "\n"
    "## Do NOT\n\n"
